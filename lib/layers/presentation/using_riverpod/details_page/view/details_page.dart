...
import 'package:clean_template/layers/presentation/using_riverpod/details_page/notifier/details_page_notifier.dart';
...
// View
// -----------------------------------------------------------------------------
class CharacterDetailsView extends ConsumerStatefulWidget {
  const CharacterDetailsView({super.key, required this.character});

  final Character character;

  @override
  ConsumerState<CharacterDetailsView> createState() =>
      _CharacterDetailsViewState();
}

class _CharacterDetailsViewState extends ConsumerState<CharacterDetailsView> {
  @override
  void initState() {
    super.initState();
    ref.read(detailsPageProvider.notifier).setCharacter(widget.character);
  }
...
class _Content extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final character = ref.watch(detailsPageProvider).character;
    if (character == null) {
